...
We would appreciate your support in the following areas: *(more details in the [issues here](https://codeberg.org/icrc-global-cyber-hub/iami/issues))*
* Integrate New Tools
...
The tasks listed below are partially based on the roadmap of [IDPS-ESCAPE](https://github.com/AbstractionsLab/idps-escape). 
...
The tasks listed below are partially based on the roadmap of [SATRAP-DL](https://github.com/AbstractionsLab/satrap-dl).
...
- Discuss and study refinements to the CTI scoring formula based on other available taxonomies in MISP, object grouping and [MISP decaying models](https://github.com/MISP/misp-decaying-models)
